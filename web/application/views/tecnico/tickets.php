                        ...
                        <table data-link="" id="tickets" class="table table-bordered table-hover display nowrap">
                            ...
                            foreach ($tickets as $ticket) {
                                echo '<tr style="cursor: pointer;">
                                            <td><a  href="' . site_url('tecnico/ver_ticket/' . $ticket['id_ticket']) . '"></a>' . $ticket['id_ticket'] . '</td>
                                            <td><a href="' . site_url('tecnico/ver_cliente/') . $ticket['cliente'] . '">' . $ticket['nombre_cliente'] . '</a></td>
                                            <td>' . $ticket['titulo'] . '</td>
