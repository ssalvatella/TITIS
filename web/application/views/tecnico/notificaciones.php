                        ...
                        <li style="margin-right: 0px;">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body">
                                    <a target="_blank" href="<?= site_url('tecnico/' . $notificaciones[$i]['url']); ?>" onClick="borrar_notificacion(this, <?= $notificaciones[$i]['id_notificacion']; ?>)"><?= sprintf($this->lang->line($notificaciones[$i]['texto']), '<b>' . $notificaciones[$i]['parametros'] . '</b>'); ?></a>
                                </div>
                            </div>
                        </li>
                    <?php } ?>
