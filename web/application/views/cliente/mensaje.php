    ...
    <div class="modal fade" id="modal_enviar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-lg modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" id ="enviar_mensaje_form" method="POST" action="<?= site_url('cliente/enviar_mensaje_privado/'. $this->uri->segment(2) . '/' .$this->uri->segment(3)) ; ?>" >
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="<?= site_url('cliente/mensajes') ?>"><i class="fa fa-inbox"></i> <?= $this->lang->line('recibidos'); ?>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding" >
                        ...
                        <div class="mailbox-controls with-border text-center">
                            <div class="btn-group">
                                <a href="<?= site_url('cliente/eliminar_mensaje/' . $mensaje['id_mensaje'])?>" type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="" data-original-title="<?= $this->lang->line('eliminar'); ?>">
                        ...
                        if (count($mensaje['archivos']) != 0) {
                            ...
                            foreach ($mensaje['archivos'] as $archivo) {
                                ...
                                echo '<div class="mailbox-attachment-info">
                                     <a href="'. site_url('cliente/descargar_archivo/' . $archivo['nombre_archivo'] . '/' . $archivo['nombre_original']) .'" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> ' . $archivo['nombre_original'] . '</a>
                                     <span class="mailbox-attachment-size">
                                         ' . $archivo['tamano'] . ' KB
                                        <a href="'. site_url('cliente/descargar_archivo/' . $archivo['nombre_archivo'] . '/' . $archivo['nombre_original']) .'" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                     </span>
                                  </div>';
                                echo '</li>';
                            }
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?= site_url('cliente/eliminar_mensaje/' . $mensaje['id_mensaje'])?>" type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> <?= $this->lang->line('eliminar'); ?></a>
