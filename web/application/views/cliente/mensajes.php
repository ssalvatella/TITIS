<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= $this->lang->line('mensajes_titulo'); ?></li>
        </ol>
    </section>
    ...
    <div class="modal fade" id="modal_enviar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-lg modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" id ="enviar_mensaje_form" method="POST" action="<?= site_url('cliente/enviar_mensaje_privado/mensajes'); ?>" >
                            ...
                            <table id= "mensajes" class="table table-hover table-striped" >
                                ...
                                <tbody>
                                    ...
                                    foreach ($mensajes as $mensaje) {
                                        ...
                                        echo '<td> <a  href="' . site_url('cliente/ver_mensaje/' . $mensaje['id_mensaje']) . '"></a><input type="checkbox"></td>';
                                        if ($mensaje['visto'] == 0) {
                                        ...
                                        echo '<td class="mailbox-name"> <a href="' . site_url('cliente/ver_usuario/' . $mensaje['emisor']) . '">' . $mensaje['nombre_emisor'] . '</a></td>';
