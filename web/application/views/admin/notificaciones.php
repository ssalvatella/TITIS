                ...
                for ($i = 0; $i < count($notificaciones); ++$i) {
                    ...
                    echo '<li style="margin-right: 0px;">
                                ...
                                <div class="timeline-item">
                                    <span class="time"><a href="' . site_url('admin/eliminar_notificacion/' . $notificaciones[$i]['id_notificacion']) . '"><i class="remove glyphicon glyphicon-remove-sign glyphicon-white"></i></a></span> <span class="time"><i class="fa fa-clock-o"></i> &nbsp; ' . date('H:i', strtotime($notificaciones[$i]['fecha'])) . '</span>
                                    <div class="timeline-body">
                                        <a href="' . $notificaciones[$i]['url'] . '">' . sprintf($this->lang->line($notificaciones[$i]['texto']), '<b>' . $notificaciones[$i]['parametros'] . '</b>') . '</a>
                                    </div>
                                </div>
                              </li>';
                }
