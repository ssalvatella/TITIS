                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="info-box bg-red">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number" style="font-size:17px;"> <a style="color: inherit;" href="<?= site_url('tecnico_admin/ver_cliente/') . $ticket['id_cliente'] ?>"><?= $ticket['nombre_cliente'] ?></a></span>
        ...
        <div class="" style="margin:0 auto; background-color: #ecf0f5; padding-top: 30px">
            <ul class="timeline">
                    ...
                    <li style="margin-right: 0px;">
                        ...
                        <div class="timeline-item">
                            ...
                            <h3 class="timeline-header">
                                <a href="<?= site_url('tecnico_admin/ver_usuario/' . $mensajes[$i]['usuario']) ?>"><?= $mensajes[$i]['nombre_usuario']; ?></a> <?= $this->lang->line('ha_escrito_comentario'); ?> <?php if ($mensajes[$i]['destinatario'] == USUARIO_CLIENTE) { ?>
                ...
                <li style="margin-right: 0px;">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-body">
                            <form id="form_enviar_mensaje" enctype="multipart/form-data" method="POST" action="<?= site_url('tecnico_admin/enviar_mensaje/') . $ticket['id_ticket']; ?>" data-parsley-errors-messages-disabled="true">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
