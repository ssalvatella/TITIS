<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= site_url('tecnico_admin/clientes'); ?>"><?= $this->lang->line('clientes'); ?></a></li>
    ...
    <div class="modal fade" id="modal_mensaje" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-lg modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" id ="enviar_mensaje_form" method="POST" action="<?= site_url('tecnico_admin/enviar_mensaje_privado/' . $this->uri->segment(2) . '/' . $this->uri->segment(3)); ?>" >
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="timeline">
                            ...
                            <ul class="timeline timeline-inverse">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header"><a href="">' . $cliente['nombre'] . '</a> ' . $this->lang->line('cliente_envio_ticket') . '<a href="' . site_url('tecnico_admin/ver_ticket/' . $tickets[$i]['id_ticket']) . '">' . $tickets[$i]['titulo'] . '</a></h3>
                                </div>
                              </li>';
                                }
                        ...
                        <div class="<?= $tab_activa == 'editar' ? 'active' : '' ?> tab-pane" id="settings">
                            ...
                            <?php } ?>
                            <form id="form-editar" class="form-horizontal"  action="<?= site_url('tecnico_admin/ver_cliente/' . $id_cliente); ?>" method="POST" role="form" data-parsley-errors-messages-disabled="true">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
